...
class qi_mod(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "qi_mod")
        ...
        self.rational_resampler_xxx_0 = filter.rational_resampler_fff(
                ...
                taps=[],
                fractional_bw=0)
        self.blocks_wavfile_source_1 = blocks.wavfile_source('/home/abhineetagarwal/Downloads/background.wav', True)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/abhineetagarwal/Downloads/vocal.wav', True)
        self.blocks_multiply_xx_1 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, 'data1.dat', False)
...
def main(top_block_cls=qi_mod, options=None):
