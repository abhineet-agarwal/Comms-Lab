...
class dsbfc(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "dsbfc")
        ...
        self.connect((self.rational_resampler_xxx_0, 0), (self.qtgui_time_sink_x_2, 0))
...
def main(top_block_cls=dsbfc, options=None):
