...
class ssb(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/abhineetagarwal/Downloads/vocal.wav', True)
        ...
        self.analog_sig_source_x_1_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 200000, 1, 0, 0)
        self.analog_sig_source_x_1_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 200000, 1, 0, 0)
        self.analog_sig_source_x_1_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 200000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_1_0_0, 0), (self.blocks_multiply_xx_3, 0))
        self.connect((self.analog_sig_source_x_1_1, 0), (self.blocks_multiply_xx_2, 0))
        ...
        self.connect((self.blocks_multiply_xx_3, 0), (self.low_pass_filter_0, 0))
        self.connect((self.blocks_sub_xx_0, 0), (self.blocks_multiply_xx_2, 1))
        self.connect((self.blocks_sub_xx_0, 0), (self.blocks_multiply_xx_3, 1))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 12000, 100, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.samp_rate, 12000, 100, window.WIN_HAMMING, 6.76))
